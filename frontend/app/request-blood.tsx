    ...
    >
      <View style={Platform.OS === "web" ? styles.webCenterWrapper : null}>
        <View style={styles.scrollContent}>
          ...
          {/* ── Blood Group ──────────────────────────────────── */}
          <Text
            style={[styles.label, { color: theme.text, marginTop: Spacing.lg }]}
          >
            ...
            {BLOOD_GROUPS.map((group) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      form.bloodGroup === group ? theme.primary : theme.surface,
                    borderColor:
                      form.bloodGroup === group ? theme.primary : theme.border,
                  },
                ]}
              >
                <Text
          ...
          {/* ── Urgency ──────────────────────────────────────── */}
          <Text
            style={[styles.label, { color: theme.text, marginTop: Spacing.md }]}
          >
            Urgency Level
          </Text>
            ...
            {URGENCIES.map((u) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      form.urgency === u.label ? u.color : theme.surface,
                    borderColor:
                      form.urgency === u.label ? u.color : theme.border,
                  },
                ]}
              >
                <Text
                  style={[
                    styles.urgencyText,
                    { color: form.urgency === u.label ? "#FFF" : theme.text },
                  ]}
                >
                  {u.label}
                </Text>
